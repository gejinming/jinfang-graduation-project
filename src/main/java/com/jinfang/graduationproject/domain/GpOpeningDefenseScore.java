 ...
 * ---------------------------
 */
public class GpOpeningDefenseScore {

	/**  */
	private Long id;
	/** 开题答辩ID */
	private Long openingDefenseId;
	/** 成绩组成id */
	...
	public Long getOpeningDefenseId() {
		return openingDefenseId;
	}

	public void setOpeningDefenseId(Long openingDefenseId) {
		this.openingDefenseId = openingDefenseId;
	}
