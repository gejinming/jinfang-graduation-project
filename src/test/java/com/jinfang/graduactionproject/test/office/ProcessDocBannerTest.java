...
public class ProcessDocBannerTest extends BasicOfficeTest {
    ...
    public void init() {
        ...
        sourceFileName = "1-process_doc_banner.docx";
        targetFileName = "1-process_doc_banner-" + System.currentTimeMillis() + ".docx";
    }
